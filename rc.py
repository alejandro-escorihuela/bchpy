...
if __name__ == "__main__":
    ...
    # t0 = tm.time()
    # met = Metode()
    # met.setABA(b[0].expand(complex=True), a[0], b[1].expand(complex=True), a[1], b[2].expand(complex=True), a[2],
    ...
    # t0 = tm.time()
    # met = Metode()
    # met.setABA(b[0].expand(complex=True), a[0], b[1].expand(complex=True), a[1], b[2].expand(complex=True), a[2], b[3].expand(complex=True), a[3],
    ...
    t0 = tm.time()
    met = Metode()
    met.setABA(b[0].expand(complex=True), a[0], b[1].expand(complex=True), a[1],
