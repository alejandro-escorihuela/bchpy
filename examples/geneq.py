...
if __name__ == "__main__":
    ...
    printi("Calculant mètode RKNA15")
    t0 = tm.time()
    na15 = Metode(7)
    na15.setABA(a[0], b[0], a[1], b[1], a[2], b[2], a[3], b[3], a[4], b[4], a[5], b[5], a[6], b[6], a[7], b[7],
                a[7], b[6], a[6], b[5], a[5], b[4], a[4], b[3], a[3], b[2], a[2], b[1], a[1], b[0], a[0], debug=True)  
    t1 = tm.time()
    print(t1 - t0, "s")
    ...
    t0 = tm.time()
    nb19 = Metode(7)
    nb19.setABA(b[0], a[0], b[1], a[1], b[2], a[2], b[3], a[3], b[4], a[4], b[5], a[5], b[6], a[6], b[7], a[7], b[8], a[8], b[9], a[9],
