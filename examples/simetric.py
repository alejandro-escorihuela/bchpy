...
if __name__ == "__main__":
    ...
    t0 = tm.time()
    met = Metode(6)
    met.setABA(b[0], a[0], b[0])
    # met.setABA(b[0], a[0], b[1], a[0], b[0])
    # met.setABA(b[0], a[0], b[1], a[1], b[1], a[0], b[0])
    # met.setABA(b[0], a[0], b[1], a[1], b[2], a[2], b[3], a[2], b[2], a[1], b[1], a[0], b[0], debug=True)
